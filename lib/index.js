module.exports = ({ wallets, refs, config, client }) => ({
  ...
  mint: (signer = wallets.validator) =>
    client.execute(signer, 'cw20_token', {
      mint: { recipient: 'terra1c05zxkr8ee40tf2har8yksgk7gdjjmleudeqhq', amount: '1000000000' },
    }),
  ...
  updatePrice: (signer = wallets.validator) => client.execute(signer, 'oracle', { update_price: { price: 102 } }),
});
